...
このモジュールには、指定されたメトリクスデータフォルダから、トレーニング損失、テスト損失、およびテスト精度のグラフをプロットする関数が含まれています。
...
このモジュールは、トレーニングとテストのメトリクスデータを読み込み、それをグラフにプロットするのに役立ちます。
"""
...
def plot_metrics_from_json(metrics_path):
    """
    指定されたメトリクスデータフォルダから、トレーニング損失、テスト損失、およびテスト精度のグラフをプロットします。
